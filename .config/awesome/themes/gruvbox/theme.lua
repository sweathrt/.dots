...
theme.wallpaper = os.getenv("HOME") .. "/pictures/wallpapers/gruvbox_streets.png"
--[[ theme.wallpaper_fn = gears.wallpaper.tiled ]]

local font_name, font_size         = "sans", "8"
local font_alt_name, font_alt_size = "monospace", "10"
...
theme.font_big         = font_name .. " " .. "Bold" .. " " .. "12"
